...
class Usuario{
    ...
    public static function cargarTodos(){
        $db=Database::conectar();
        $stmt=$db->prepare("SELECT id, nombre, nombre_usuario, correo, activo, es_admin, moderado, fecha_registro,bio, ruta_foto FROM usuarios ORDER BY fecha_registro DESC");
        $stmt->execute();
