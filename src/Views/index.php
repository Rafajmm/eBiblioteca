...
<html lang="es">
  <head>
    ...
    <title>eBiblioteca · Inicio</title>
          ...
          <form action="/login" method="POST">
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input id="loginEmail" name="email" type="email" class="form-control" placeholder="tu@email.com" required />
              </div>
              <div class="mb-3">
          ...
          <form action="/registro" method="POST">
            <div class="modal-body">
              <div class="mb-3">
                ...
                <input id="regName" name="nombre" type="text" class="form-control" placeholder="Tu nombre" required />
              </div>
              <div class="mb-3">
                <label for="regUsername" class="form-label">Nombre de usuario</label>
                <input id="regUsername" name="nombre_usuario" type="text" class="form-control" placeholder="usuario123" required />
              </div>
              <div class="mb-3">
                <label for="regEmail" class="form-label">Email</label>
                <input id="regEmail" name="email" type="email" class="form-control" placeholder="tu@email.com" required />
              </div>
              <div class="mb-3">
                <label for="regPass" class="form-label">Contraseña</label>
                <input id="regPass" name="password" type="password" class="form-control" placeholder="Mínimo 8 caracteres" required />
